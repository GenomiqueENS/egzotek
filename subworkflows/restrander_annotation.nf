...
workflow RESTRANDER_WORKFLOW {
   ...
   main:
      ...
      if (params.genome.endsWith('.gz')|| params.genome.endsWith(".bz2")){
            ...
            ch_minimap2_rnabloom_genome = file( params.genome )
      ...
      RNABLOOM_MINIMAP2(ch_minimap2_rnabloom_genome, RNA_BLOOM.out.rnabloom_fasta, params.intron_length, junc_bed)
