...
include { RNABLOOM_AGAT_BED2GFF; RNABLOOM_AGAT_GFF2GTF; AGAT_COMPLEMENT } from './modules/agat.nf'
...
//params.polishedgtf = "/home/brunon/Documents/Nextflow_training/transcript_annotation/nf_Transcript_Annotation/result/rnabloom/polished_transcriptome.gtf"
//polishedgtf_ch = Channel.fromPath(params.polishedgtf, checkIfExists:true) 

//params.ref = "/home/brunon/Documents/Nextflow_training/transcript_annotation/data/ref_genome/nHd_3.1_HiC.fasta"
...
workflow {
  // Index creation
   ...
   GFFREAD(uncompress_ch, AGAT_COMPLEMENT.out.polished_gtf)
}
